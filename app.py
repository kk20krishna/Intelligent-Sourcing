...
with gr.Blocks(theme=gr.themes.Soft()) as app:
    ...
    with gr.Tabs():
        ...
        with gr.TabItem("Run Optimization"):
            ...
            run_weightage_Cost = gr.Slider(label="Weightage Cost", minimum=0, maximum=1, value=0.25)
            run_weightage_Priority = gr.Slider(label="Weightage Priority", minimum=0, maximum=1, value=0.25)
            run_weightage_distance = gr.Slider(label="Weightage Distance", minimum=0, maximum=1, value=0.25)
            run_weightage_days = gr.Slider(label="Weightage Days", minimum=0, maximum=1, value=0.25)
